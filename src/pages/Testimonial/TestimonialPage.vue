    ...
    <div v-if="cant > 0" class="container-fluig pt-3 pb-5">
      <v-row class="sectionTestimonial" style="background-color: #0b152a">
        <v-col
          ...
          md="6"
          sm="12"
          class="d-flex align-center justify-center flex-column dataSection"
        >
        ...
        <v-col cols="12" md="6" sm="12" class="d-flex align-center videoMain">
          <iframe
            width="100%"
            height="100%"
            :src="loadURL(mainTestimonial.link).embed + '?autoplay=1&mute=0'"
          ...
          >
            <div class="testimonialVideo">
              <iframe
                width="100%"
                height="100%"
                :src="loadURL(testimonial.link).embed"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen
