        ...
        <v-col cols="12" md="6" style="height: 100vh; overflow-y:auto;">
            ...
            <v-sheet max-width="390" class="mx-auto">
                ...
                <v-form ref="loginForm" class="formlogBlue" v-model="valid">
                    ...
                    <v-text-field v-if="usuario_registrado" outlined type="password" :rules="rules" v-model="loginForm.password"></v-text-field>
                    <div class="text-left mb-4" style="font-family: 'Poppins-Regular';">
                        <v-checkbox v-model="acepta_tos" :rules="rules"> 
                            ...
                            style="color: #000; font-family:'Poppins-Regular';" @click.stop><b>términos y condiciones</b></a> y nuestra <a href="/politica-privacidad" style="color: #000; font-family:'Poppins-Regular';" @click.stop><b>política de privacidad</b></a>.</div>
                        </v-checkbox>
                    </div>
                    <v-btn class="text_btn_white_title" v-if="usuario_registrado" block depressed color="secondary" :disabled="!valid"
                        @click="loginUser">
