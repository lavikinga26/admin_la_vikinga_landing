<template>
    <v-row style="background: #fff;">
        <v-col cols="12" style="height: 100vh; overflow-y:auto;">
    ...
    methods: {
        ...
        async tokenCreated (token) {
            ...
            if(token_resul.success == true){
                ...
                const data_auth = await this.$API.stripe.authTransactionRetos(token_resul.ucard);

                this.$router.push({ path: '/gym-virtual/retos-resultado-pago/'+this.slug });
        ...
        async authPayment(){
            ...
            try{
                ...
                const data_auth = await this.$API.stripe.authTransactionUserTokenRetos(vm.selected_card);
