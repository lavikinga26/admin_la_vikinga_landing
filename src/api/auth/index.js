...
export default {
	...
	gymVirtual: {
		...
		saveAttempt(data) {
			return callAuthAPI("post", "api/v1/gymvirtual/save-attempt", {
				data: data,
			});
		},
		getActivitiesRecorded(id) {
			return callAuthAPI(
				"get",
				"api/v1/gymvirtual/getActivitiesRecorded/" + id
			);
		},
		getActivitiesUpcoming(id) {
			return callAuthAPI(
				"get",
				"api/v1/gymvirtual/getActivitiesUpcoming/" + id
			);
		},
		getActivitiesRecordedFilters(id_level, id_coach, enfoque, pageNum) {
			return callAuthAPI(
				"get",
				"api/v1/gymvirtual/getActivitiesRecordedFilter/" +
					id_level +
					"/" +
					id_coach +
					"/" +
		...
		getPesos(id_bp, id_ejercicio) {
			return callAuthAPI(
				"get",
				"api/v1/pesos/getPesos/" + id_bp + "/" + id_ejercicio
			);
		},
	},
	...
	business_partner: {
		...
		updateProfileInfo(id, data) {
			return callAuthAPI(
				"post",
				"api/v1/business-partner/update-profile-info/" + id,
				{ data: data }
			);
		},
		updateHealthInfo(id, data) {
			return callAuthAPI(
				"post",
				"api/v1/business-partner/update-health-info/" + id,
				{ data: data }
			);
		},
		updateProgressInfo(id, data) {
			return callAuthAPI(
				"post",
				"api/v1/business-partner/update-progress-info/" + id,
				{ data: data }
			);
		},
		updateNutritionInfo(id, data) {
			return callAuthAPI(
				"post",
				"api/v1/business-partner/update-nutrition-info/" + id,
				{ data: data }
			);
		},
		updateTrainingInfo(id, data) {
			return callAuthAPI(
				"post",
				"api/v1/business-partner/update-training-info/" + id,
				{ data: data }
			);
		},
		...
		uploadProfilePhoto(data) {
			return callAuthAPI(
				"post",
				"api/v1/business-partner/upload-profile-photo",
				{ data: data }
			);
		},
		uploadBodyPicture(data) {
			return callAuthAPI("post", "api/v1/business-partner/upload-body-photo", {
				data: data,
			});
		},
		getBadge() {
		...
		getDownloadsGym(id_level) {
			return callAuthAPI(
				"get",
				"api/v1/business-partner/downloadsgym/" + id_level
			);
		},
		getLibrary() {
		...
		cancelSuscription(id, motivo) {
			return callAuthAPI(
				"get",
				"api/v1/business-partner/cancelSuscription/" + id + "/" + motivo
			);
		},
		reactivateSuscription(id) {
			return callAuthAPI(
				"get",
				"api/v1/business-partner/reactivateSuscription/" + id
			);
		},
		updateLevel(level) {
		...
		getReto(id_reto) {
			return callAuthAPI("get", "api/v1/business-partner/getReto/"+id_reto);
		},
		getRetosCategories() {
		...
		retosCompradosList() {
			return callAuthAPI("get", "api/v1/retos/retosCompradosList");
		},
		updateData(data) {
			return callAuthAPI("post", "api/v1/business-partner/updateData", {
				data: data,
			});
		},
		updateTimezone(id_timezone) {
			return callAuthAPI(
				"get",
				"api/v1/business-partner/updateTimezone/" + id_timezone
			);
		},

		// Campaña retencion
		checkActiveRetention(data) {
			return callAuthAPI("post", "api/v1/retention/check/", {
				data: data,
			});
		},
		// Actualiza plan    retencion
		updatePlan(data) {
			return callAuthAPI("post", "api/v1/subscription/plan/update", {
				data: data,
			});
		},
		extendPlan(data) {
